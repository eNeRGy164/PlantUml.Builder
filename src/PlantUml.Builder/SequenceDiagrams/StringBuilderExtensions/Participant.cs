...
namespace PlantUml.Builder.SequenceDiagrams
{
    public static partial class StringBuilderExtensions
    {
        ...
        {
            stringBuilder.ParticipantBase(ParticipantType.Participant, name, displayName, color, order);
        }
        ...
        {
            stringBuilder.CreateParticipantBase(name, ParticipantType.None, displayName, color, order);
        }
    }
}
