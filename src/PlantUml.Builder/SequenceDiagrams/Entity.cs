...
namespace PlantUml.Builder.SequenceDiagrams
{
    public static partial class StringBuilderExtensions
    {
        ...
        {
            stringBuilder.ParticipantBase(ParticipantType.Entity, name, displayName, color, order);
        }
        ...
        {
            stringBuilder.CreateParticipantBase(name, ParticipantType.Entity, displayName, color, order);
        }
    }
}
